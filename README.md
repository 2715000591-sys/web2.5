...
通知页也会做高风险轻量预审：像“可疑随机账号 + 资源自取 / 点主页昵称 + 纯表情回复”这类内容，不用等点进详情页才送后台 AI。
...
- 改 `docs/ai-prompt-packs/sexual-leadgen-foundation/` 后，要同步提示词包，让云端 AI 审核实际读到教材；`npm run doctor` 会检查这条线有没有断。
