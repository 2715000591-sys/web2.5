...
- Worker Version ID：`7d573527-6054-4c19-935c-3fbafce92c01`
...
- 2026-05-04 10:34 本机 Safari 已更新到 `BUILD_ID=2026-05-04-1034`，把旧手动教学 / 历史命中合并显示为“后台学习库下沉”，把等待后台判断单独显示为“后台复审中”，并把后台返回的英文原因短句转成中文概括展示。这次没有改 AI 调度和 Worker 审核逻辑；公网发布被 Cloudflare 登录失效挡住，所以线上 AI/Worker 锚点仍是上一行的 Version ID。
