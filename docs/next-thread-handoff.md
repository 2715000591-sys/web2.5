...
- Cloudflare Worker：
  ...
  - Version ID：`fc8fba7e-1b25-48a5-b667-070d6b71032a`
...
- Safari / Web Extension：
  - `BUILD_ID = 2026-05-03-1117`
  - extension manifest version：`0.1.58`
  - App / Extension version：`1.0.58 (59)`
