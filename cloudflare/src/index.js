...
function buildReplyAiProviderPrompt(settings, options) {
  ...
  return [
    ...
    "Do not hide merely because a reply contains sexual words, erotic preferences, porn discussion, adult jokes, sex-worker discussion, or controversial adult-topic opinions.",
